  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CustomNavigationBar(
        ...
        selectedColor: AppConstantsColor.primaryColor,
        strokeColor: AppConstantsColor.primaryColor,
        unSelectedColor: AppConstantsColor.lightTextColor,
        backgroundColor: AppConstantsColor.cardColor,
        scaleFactor: 0.1,
        items: [
